...
from pyglm.switching_models import NegativeBinomialEmptyHDPHSMM
...
def fit_with_gibbs(dataset, run, seed=None):
    ...
    test_model = NegativeBinomialEmptyHDPHSMM(N=N, M=M, dt=dt, dt_max=dt_max, B=B,
                            ...
                            duration_hypers=true_model.duration_hypers)
