...
from oldpyglm.deps.pybasicbayes.abstractions import MeanField, GibbsSampling
from oldpyglm.deps.pybasicbayes.util.stats import getdatasize
from oldpyglm.internals.distributions import ScalarGaussian
