...
from pyglm.models import NegativeBinomialPopulation, StandardNegativeBinomialPopulation
...
def demo(seed=None):
    ...
    test_path = base_path + "_test.pkl.gz"
    ...
    if os.path.exists(init_path):
        ...
        init_model = StandardNegativeBinomialPopulation(N=N, xi=10, dt=dt, dt_max=dt_max, B=B,
